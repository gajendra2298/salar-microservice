import { IsString, IsOptional, IsEmail, MaxLength, Matches, IsBoolean, IsNumber, IsArray, ValidateNested } from 'class-validator';
import { ApiProperty } from '@nestjs/swagger';
import { Type } from 'class-transformer';

// Address DTO for shipping addresses (same as AddUserDto)
...
export class UpdateUserDto {
  ...
  @ApiProperty({
    description: 'Transaction password (will be encrypted)',
