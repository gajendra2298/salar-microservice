...
const funds_controller_1 = require("../src/funds/funds.controller");
const funds_service_1 = require("../src/funds/funds.service");
const funds_schema_1 = require("../src/funds/schemas/funds.schema");
describe('FundsController', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            ...
            providers: [
                ...
                {
                    provide: (0, mongoose_1.getModelToken)('Funds'),
                    useValue: mockFundsModel,
                },
            ],
        }).compile();
        controller = module.get(funds_controller_1.FundsController);
        service = module.get(funds_service_1.FundsService);
    });
    ...
    describe('fundTransfer', () => {
        it('should transfer funds successfully', async () => {
            const fundTransferDto = {
                userId: '507f1f77bcf86cd799439011',
                registerId: 'USER002',
                amount: 100,
                type: funds_schema_1.FundType.SPONSOR_COMMISSION,
    ...
    describe('getFundStatistics', () => {
        it('should return fund statistics for a user', async () => {
            ...
            expect(result.data.netAmount).toBe(-200);
        });
    });
});
